...
$result = $ConstantsModel->where('constants_id', $category_id)->where('type','training_type')->where('company_id', effective_company_id())->first();
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="name" placeholder="<?= lang('Dashboard.left_training_skill');?>" value="<?= esc($result['category_name'] ?? '', 'attr');?>">
      </div>
    </div>
  </div>
</div>
