...
$result = $ConstantsModel->where('constants_id', $category_id)->where('type','competencies')->where('company_id', effective_company_id())->first();
...
$category_id = udecode($field_id);
$result = $ConstantsModel->where('constants_id', $category_id)->where('type','competencies2')->where('company_id', effective_company_id())->first();
if(!is_array($result)){ echo dialog_not_found(); return; }
?>
