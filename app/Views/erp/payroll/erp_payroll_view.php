            ...
            <div class="row invoive-info d-pdrint-inline-flex justify-content-md-center">
              ...
              <div class="col-md-6">
                ...
                <h4 class="text-uppercase text-primary m-l-30"> <strong>
                  <?= money_fmt($payslip_data['net_salary']);?>
                  </strong> </h4>
              </div>
            </div>
            <div class="row">
                  ...
                  <table class="table m-b-0 f-14 b-solid requid-table">
                    ...
                    <tbody class="text-muted">
                      <tr>
                        ...
                        <td class="text-success"><?= money_fmt($payslip_data['basic_salary']);?></td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td><?= money_fmt($_allowance['pay_amount']);?></td>
                      </tr>
                      <?php endforeach?>
                      <?php } ?>
                      ...
                      <tr>
                        ...
                        <td><?= money_fmt($_commission['pay_amount']);?></td>
                      </tr>
                      <?php endforeach?>
                      <?php } ?>
                      ...
                      <tr>
                        ...
                        <td><?= money_fmt($_otherpayment['pay_amount']);?></td>
                      </tr>
                      <?php endforeach?>
                      <?php } ?>
                    </tbody>
                    ...
                    <tbody class="text-muted">
                      ...
                      <tr>
                        ...
                        <td><span class="text-danger">
                          <?= money_fmt($_statutory['pay_amount']);?>
                          </span></td>
                      </tr>
                      <?php endforeach?>
                      <?php } ?>
                  ...
                  <tbody>
                    <tr>
                      <th><?= lang('Payroll.xin_total_earning');?>
                        :</th>
                      <td><?= money_fmt($total_earning);?></td>
                    </tr>
                    <tr>
                      <th><?= lang('Payroll.xin_total_deductions');?>
                        :</th>
                      <td><?= money_fmt($total_deduction);?></td>
                    </tr>
                    <tr class="text-info">
                      <td><hr>
